...
let s:colors = {
      ...
      \ "white": get(s:overrides, "white", { "gui": "#C5C8C6", "cterm": "251", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#161719", "cterm": "234", "cterm16": "0" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#222326", "cterm": "235", "cterm16": "8" }),
